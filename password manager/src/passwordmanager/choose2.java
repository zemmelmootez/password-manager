...
public class choose2  extends JFrame{
    ...
    public   choose2(String email,String pw)
    {
        ...
        btn11.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    get_social_account s=new get_social_account(email,pw);
        ...
        btn2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    get_bank w=new get_bank(email,pw);
                } catch (SQLException ex) {
                    ex.printStackTrace();
                }
            }
        ...
        btn3.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    get_wifi w=new get_wifi(email,pw);
                } catch (SQLException ex) {
                    ex.printStackTrace();
                }
            }
